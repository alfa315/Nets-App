...
import { Tab, Dropdown, Icon, Popup, Button } from 'semantic-ui-react'
    ...
    <Tab.Pane style = {{height: "315px"}}>
      <div style={{display: "flex"}}>
        ...
        <div className='centered' style = {{marginTop: "4%"}}>
          ...
          <Popup
            trigger={<Icon style={{marginTop: "25px"}} size='big' name='help circle' />}
            content="This tool evaluates trades of draft picks by assigning a value to each pick and determining what team will have the highest return value based on the picks being exchanged by each team."
            style = {{width:'auto', fontSize: "17px"}}
            inverted
          />
          <p>Need Help?</p>
          <Button color="black" size="small" onClick={props.reset}>Reset</Button>
        </div>
