...
const HistoryList = (props) => {
  return (
    <List>
      <List.Item>
        <Image avatar src={`https://nba-players.herokuapp.com/players/${props.player.lastName.replace(/[.']/g,'').split(" ").join("_")}/${props.player.firstName.replace(/[.']/g,'').split(" ").join("_")}`} onError={(e)=>{e.target.onerror = null; e.target.src=require(`../../images/eggHead.jpg`)}} />
        <List.Content>
