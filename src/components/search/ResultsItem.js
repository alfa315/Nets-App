  ...
  if(props.results.length === 0 || props.results === undefined || props.teams.length === 0 || props.teams === undefined) {
    ...
    return (
      <List.Item className='searchItem'>
        <Image circular size='small'  src={`https://nba-players.herokuapp.com/players/${lastName}/${firstName}`} onError={(e)=>{e.target.onerror = null; e.target.src=require(`../../images/eggHead.jpg`)}}/>
